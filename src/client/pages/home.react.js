      ...
      <DocumentTitle title="Home">
        <div className="home-page">
          <section className="initial-screen">
            ...
            <svg className="logo-without-text" height="532" viewBox="0 0 88.6 66.5" width="708.8">
              <polygon fill="#C41721" points="0,0 0,23.9 30.6,44.3 0,64.7 0,88.6 66.5,44.3" transform="translate(0,66.5) rotate(-90, 0, 0)"/>
            </svg>

            <svg className="logo-with-text" height="129.7" viewBox="0 0 465.4 129.7" width="465.4">
              <g>
